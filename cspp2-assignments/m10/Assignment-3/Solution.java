        ...
        switch (objectType) {
            case "S"://This case will be executed for String type list
                ...
                while (stdin.hasNext()) {
                    ...
                    // based on the list op invoke the corresponding method
                    switch (tokens[0]) {
                        case "add":
                ...
                while (stdin.hasNext()) {
                    ...
                    switch (tokens[0]) {
                        ...
                        // it is the number of items in the list
                            ...
                            break;
                        case "print":
                        // print the list(implement toString in StrList class
                        //for this to work)
                        // expected format is [item-1,item-2,...,item-n]
                        // review the output testcase file
            ...
            case "O"://This will be executed for Student type list
